...
export default function EditEcoponto({ ecoponto, onNavigate }) {
  ...
  async function handleSubmit(event) {
    ...
    try {
      const res = await fetch(`http://localhost:3000/ecoponto/atualizar/${ecoponto.id}`, {
        method: "PUT",
      ...
      if (!res.ok) {
        ...
        throw new Error(payload.erro || "Failed to update ecoponto");
      }
