...
export default function EditDeposito({ deposito, onNavigate }) {
  ...
  async function handleSubmit(event) {
    ...
    try {
      const res = await fetch(`http://localhost:3000/deposito/atualizar/${deposito.id}`, {
        method: "PUT",
      ...
      if (!res.ok) {
        ...
        throw new Error(payload.erro || "Failed to update depósito");
      }
